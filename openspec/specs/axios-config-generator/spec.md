...
## Purpose
Defines the interactive configuration generator exposed by `nix run github:kcalvelli/axios#init`, including both new-configuration and add-host workflows.
