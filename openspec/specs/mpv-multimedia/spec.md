...
Provides unified audio and video playback using mpv with FFmpeg decoding and PipeWire audio output, avoiding GStreamer entirely.
...
- **Configuration**: `home/desktop/mpv.nix`
- **Scripts**: uosc (UI), thumbfast (thumbnails), mpris (media keys)
- **Backend**: FFmpeg for decoding, PipeWire for audio output
