...
The AI module SHALL expose additional OpenAI ecosystem tools from `nixpkgs` as explicit companion choices under `services.ai.openai`, rather than installing every available OpenAI-related package by default.
