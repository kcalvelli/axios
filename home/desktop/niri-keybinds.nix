...
in
{
  ...
  # DMS will populate these files with actual configuration when it runs
  xdg.configFile."niri/dms/outputs.kdl".text = ''
    ...
    // DMS will populate this file with monitor output configuration
  '';
  ...
  xdg.configFile."niri/dms/windowrules.kdl".text = ''
    ...
    // DMS will populate this file with window rules
  '';
  ...
  xdg.configFile."niri/dms/cursor.kdl".text = ''
    ...
    // DMS will populate this file with cursor configuration
  '';
  ...
  xdg.configFile."niri/dms/alttab.kdl".text = ''
    ...
    // DMS will populate this file with alt-tab configuration
  '';
  ...
  xdg.configFile."niri/dms/binds.kdl".text = ''
    ...
    // DMS will populate this file with keybinding configuration
  '';
  ...
  xdg.configFile."niri/dms/colors.kdl".text = ''
    ...
    // DMS will populate this file with color configuration
  '';
  ...
  xdg.configFile."niri/dms/layout.kdl".text = ''
    ...
    // DMS will populate this file with layout configuration
  '';

  xdg.configFile."niri/dms/wpblur.kdl".text = ''
    // ! DO NOT EDIT !
    // ! AUTO-GENERATED BY DMS !
    // ! CHANGES WILL BE OVERWRITTEN !
    // ! PLACE YOUR CUSTOM CONFIGURATION ELSEWHERE !

    // DMS will populate this file with wallpaper blur configuration
  '';
}
