...
function M.get_languages()
  local langs_str = os.getenv("CAIRN_NVIM_LANGUAGES") or ""
  local langs = {}
...
function M.setup(opts)
  ...
  require("cairn.config.options")
  require("cairn.config.keymaps")
  require("cairn.config.autocmds")

  -- Collect plugin specs from cairn preset
  local plugins = require("cairn.plugins")
  ...
  -- Note: no global `lazy = true` default — cairn plugins declare their own
