...
local general = augroup("CairnGeneral", { clear = true })
...
autocmd("BufReadPost", {
  ...
  callback = function(event)
    ...
    local buf = event.buf
    if vim.tbl_contains(exclude, vim.bo[buf].filetype) or vim.b[buf].cairn_last_loc then
      return
    end
    vim.b[buf].cairn_last_loc = true
