...
One-page command reference for Cairn MCP integration.
...
# Execute a tool
mcp-gw github/search_repositories '{"query": "cairn"}'
```
...
| **cairn-mail** | AI-powered email | PIM module |
...
| `~/.config/ai/prompts/cairn.md` | System prompt for AI agents |
...
grep -q "cairn" ~/.claude.json && echo "Enabled" || echo "Not found"
```
